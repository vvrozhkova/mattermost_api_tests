...
def test_create_message(base_url):
    """
     ...
     2. В теле ответа вернулись данные пользователя, который добавил сообщение
     3. В списке сообщений присутствует новое созданное сообщение
     """
...
def test_get_channel_messages(base_url):
    """
     ...
     2. В теле ответа вернулся не пустой список posts
     """
    channel_messages = get_channel_messages(base_url, channel_id)
